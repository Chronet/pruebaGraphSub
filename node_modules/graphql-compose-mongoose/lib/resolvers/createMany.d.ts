...
export declare function createMany<TSource = any, TContext = any, TDoc extends Document = any>(model: Model<TDoc>, tc: ObjectTypeComposer<TDoc, TContext> | InterfaceTypeComposer<TDoc, TContext>, opts?: CreateManyResolverOpts): Resolver<TSource, TContext, TArgs, TDoc>;
export {};
